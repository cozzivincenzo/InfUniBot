...
first_semester_string = string_array['ADE'] + string_array['PR1'] + string_array['MD'] + string_array['OFA']

second_semester_string = string_array['PSD'] + string_array['MMI'] + string_array['ANAL']
